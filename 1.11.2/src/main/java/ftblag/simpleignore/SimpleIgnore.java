...
@Mod(modid = SimpleIgnore.MODID, name = "Simple Ignore", version = "@VERSION@", acceptableRemoteVersions = "*", clientSideOnly = true, guiFactory = "ftblag.simpleignore.GuiFactory", acceptedMinecraftVersions = "[1.11.2]")
